...
var startIsString = true;
var endIsString = true;

var inputList = ['textEncodeText', 'textDecodeText', 'textEncodeNumbers', 'numbersDecodeText', 'textEncodeSymbols', 'symbolsDecodeText'];

function translateLetter(startLetters, endLetters, oldLetter) {
  var charIndex = startLetters.indexOf(oldLetter);
...
function encodeBase(startLetters, endLetters, inputText) {
  ...
  for (var i = 0; i < inputText.length; i++) {
    var oldLetter = startIsString ? inputText.charAt(i).toUpperCase() : numberArray[i];
    var newLetter = translateLetter(startLetters, endLetters, oldLetter);
...
function renderMessage(decodedMessage, encodedMessage) {
  var newDecodedMessage = document.createElement('p');
  newDecodedMessage.innerText = decodedMessage.toUpperCase();
  var newEncodedMessage = document.createElement('p');
...
function textEncodeText(event) {
  ...
  var newMessage = encodeBase(alphabet.base, alphabet.letterCypher, inputText);
...
function textEncodeNumbers(event) {
  ...
  event.preventDefault();
  var inputText = data.message.text;
  var newMessage = encodeBase(alphabet.base, alphabet.numberCypher, inputText);
  renderMessage(inputText, newMessage);
}
...
function textEncodeSymbols(event) {
  ...
  event.preventDefault();
  var inputText = data.message.text;
  var newMessage = encodeBase(alphabet.base, alphabet.symbolCypher, inputText);
  renderMessage(inputText, newMessage);
}
...
function textDecodeText(event) {
  ...
  event.preventDefault();
  var inputText = data.message.text;
  var newMessage = encodeBase(alphabet.letterCypher, alphabet.base, inputText);
...
function numbersDecodeText(event) {
  ...
  event.preventDefault();
  var inputText = data.message.text;
  var newMessage = encodeBase(alphabet.numberCypher, alphabet.base, inputText);
  renderMessage(newMessage, inputText);
}
...
function symbolsDecodeText(event) {
  ...
  event.preventDefault();
  var inputText = data.message.text;
  var newMessage = encodeBase(alphabet.symbolCypher, alphabet.base, inputText);
  renderMessage(newMessage, inputText);
}
...
var base = 'YMXPCTIWQFAZNDHOJLVEKBGUSR';
var letterCypher = 'ZDPKVGMYEAHLUSIWNFQOCRJXTB';
var symbolCypher = '~!@#$%^&*()-+=:;<>[]{}\\/©€';

var numberCypher = [21, 3, 14, 25, 11, 24, 16, 23, 2, 18, 26, 1, 15, 4, 19, 7, 10, 5, 8, 13, 20, 6, 12, 9, 17, 18];

module.exports = {
  base: base,
  letterCypher: letterCypher,
  symbolCypher: symbolCypher,
  numberCypher: numberCypher
};
